// <copyright file="JsonConfigEditor.cs" company="Karatekid2501">
...
namespace CoinCollection
{
    ...
    public class JsonValueEdit<T>(string keyName, T keyValue) : JsonValueEditBase(keyName)
        where T : notnull
    {
        /// <summary>
        /// Gets key value.
    ...
    public class JsonValueEditGroup(string name, params JsonValueEditBase[] values)
    {
        ...
        /// <summary>
        /// Gets arry of the json values within the group.
        /// </summary>
    ...
    /// </summary>
    public partial class JsonConfigEditor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonConfigEditor"/> class.
        /// </summary>
        /// <param name="jsonFileName">File name of the Json file.</param>
        /// <param name="options">Serailisation options for the Json file.</param>
    ...
    /// <summary>
    /// Json configerator editor implementation.
    /// </summary>
    public partial class JsonConfigEditor
    {
        /// <summary>
        /// Gets a value indicating whether checks if the json config is not null.
        /// </summary>
        public bool CheckJsonConfig => _jsonConfig != null;

        /// <summary>
        /// Gets a value indicating whether the config file path exists.
        /// </summary>
        public bool ConfigFileExist => File.Exists(ConfigPath);
        ...
        /// </summary>
        /// <returns>True if the config path and _jsonConfig variable were successful.</returns>
        ...
        /// <param name="parents">Parent hierarchy.</param>
        /// <returns>True if the value was foun and was the correct type.</returns>
        /// <exception cref="InvalidCastException">Thrown when keyName can not be converted to keyValue.</exception>
        /// <exception cref="ArgumentNullException">Thrown when there is no mention of keyName in the Json file.</exception>
        public bool Set<T>(string keyName, T keyValue, params string[] parents)
            where T : notnull
        {
        ...
        /// <param name="parents">Parent hierarchy.</param>
        /// <returns>Found value as type.</returns>
        ...
        /// <exception cref="Exception">When the json object can not be found with in the parent.</exception>
        private static JsonObject FindParent(JsonObject jsonObject, params string[] parents)
        {
            ...
            foreach (string name in parents)
            {
                ...
                {
                    throw new ArgumentException($"Unable to find {name} in {currentObject.GetPropertyName()}!!!");
                }
            }
